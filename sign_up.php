              ...
              <div class="weight-50">
                ...
                <form action="process_sign_up.php" method="post">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <input class="form-control" type="text" name="middleInitial" id="middleInitial" placeholder="Optional">
                      </div>
                      <div class="col-sm-4">
                        <label for="lName">Last Name</label><br>
                        <input class="form-control" type="text" name="lName" id="lName" pattern="^[^\s].+[^\s]$" title="must be no space in start or end">
                      </div>
                    </div>
                  </div><br>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="email" name="email" id="email" pattern="^[^\s].+[^\s]$" title="must be no space in start or end">
                  </div><br>
                  <div class="form-group">
                    <label for="contactNo">Contact Number</label><br>
                    <input class="form-control" type="text" maxlength = "11" name="contactNo" id="contactNo" pattern="^[^\s].+[^\s]$" title="must be no space in start or end">
                  </div><br>
                  <div class="form-group">
                    <label for="address">Address</label><br>
                    <input class="form-control" type="text" name="address" id="address" pattern="^[^\s].+[^\s]$" title="must be no space in start or end">
                  </div><br>
                  <div class="form-group">
