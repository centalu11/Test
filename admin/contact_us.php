  ...
  <body>
    ...
    <section style="padding-top:2rem; padding-bottom:2rem; min-height: 70vh; background-color: #f8f8f8;" class="content-center">
      ...
      <div class="d-flex justify-content-center">
          <button class="btn btn-outline-light" type="button" name="button" style="border-radius:50px; background-color: #ede8e8; font-size: 25px; "><a href="add_user.php" class="text-dark" style="text-decoration: none"><i class="fas fa-print"></i> Print Feedback</button>
        </a>
      </div>
    </section>
