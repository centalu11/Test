<?php
  ...
  if($usernameCount->cnt == 0){
    $insertUser = "INSERT INTO users (username, email, password, firstName, middleInitial, lastName, role, sectionID, contactNo, address, age, gender, civilStatus) VALUES ('$username', '', '$password', 'Admin', '', '', 'admin', '', '', '', '', '', '')";
